# This Makefile is for the POE::Component::PXR extension to perl.
#
...
#     NAME => q[POE::Component::PXR]
#     PREREQ_PM => { PXR=>q[0], POE::Filter::XML=>q[0], POE=>q[0] }
#     VERSION_FROM => q[POE/Component/PXR.pm]
...
DISTNAME = POE-Component-PXR
NAME_SYM = POE_Component_PXR
VERSION = 0.1
VERSION_SYM = 0_1
XS_VERSION = 0.1
...
TO_INST_PM = lib/POE/Component/PXR.pm

PM_TO_BLIB = lib/POE/Component/PXR.pm \
	blib/lib/POE/Component/PXR.pm
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/POE/Component/PXR.pm
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/POE/Component/PXR.pm blib/lib/POE/Component/PXR.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
